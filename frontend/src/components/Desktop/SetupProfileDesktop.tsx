...
interface SetupProfileDesktopProps {
  nickname: string;
...
const SetupProfileDesktop: React.FC<SetupProfileDesktopProps> = ({
  nickname,
  imageUrl,
  error,
  slides,
  ...
  return (
    <div className="slider-container">
      ...
      <div className="nav-btn nav-btn-desktop">
...
export default SetupProfileDesktop;
